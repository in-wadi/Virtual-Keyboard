const buttons = {
  ...
  row2: [
    ...
    {
      keyCode: '219',
      name: 'SquigglyBracketsLeft',
      simbols: ['х', 'Х', '[', '{'],
      class: 'key',
    },
    {
      keyCode: '221',
      name: 'SquigglyBracketsRight',
      simbols: ['ъ', 'Ъ', ']', '}'],
      class: 'key',
    },
    {
...
function getbuttons() {
  ...
  message.innerHTML = 'The keyboard was created in the Windows operating system. To switch language combination: left shift + alt';
